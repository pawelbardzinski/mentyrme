...
User.create(email: "none@gmail.com", first_name: "Johnny", last_name: "Mnemonic", zip_code: "91789", is_mentor: false, password: 'verylongpassword1!')
User.create(email: "none5@none.com", first_name: "Princess", last_name: "Leya", zip_code: "91789", is_mentor: true, merchant_account_id: "princess_princess_instant_668nxqgs", password: 'verylongpassword1!')
User.create(email: "none4@none.com", first_name: "Han", last_name: "Solo", zip_code: "91789", is_mentor: true, merchant_account_id: "han_han_instant_qwpznfhy", password: 'verylongpassword1!')
User.create(email: "none3@none.com", first_name: "Luke", last_name: "Skywalker", zip_code: "91789", is_mentor: true, merchant_account_id: "luke_luke_instant_rggxzxrg", password: 'verylongpassword1!')
User.create(email: "none2@none.com", first_name: "Palpatine", last_name: "Cosinga", zip_code: "91789", is_mentor: true, merchant_account_id: "palpatine_palpatine_instant_8x9kyk88", password: 'verylongpassword1!')
User.create(email: "none@none.com", first_name: "Chewbacca", last_name: "Wookiee", zip_code: "91789", is_mentor: true, merchant_account_id: "chewbacca_chewbacca_instant_h2g64qhy", password: 'verylongpassword1!')
